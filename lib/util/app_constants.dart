...
class AppConstants {
  static const String appName = 'Marty Delivery';
  static const double appVersion = 2.1;

  static const String baseUrl = 'https://test.marty.com.ng';
  ...
  static const String withdrawUri = '/api/v1/delivery-man/driver-withdrawalrequest?token=';
  ...
  static const String withdrawalUri = '/api/v1/delivery-man/driver-withdrawalstatus?token=';
  static const String cancelBankUpdateUri = '/api/v1/delivery-man/bank_req_cancel?token=';
  static const String newBankUri = '/api/v1/delivery-man/bank_req_status?token=';
  ...
  static const String getCompaniesUri = '/api/v1/delcoms';
  static const String updateAccountUri = '/api/v1/delivery-man/update_bank_info?token=';
  static const String cancelWithdrawalUri = '/api/v1/delivery-man/driver-withdrawalcancel?token=';
  static const String totalWithUri = '/api/v1/delivery-man/driver-withdrawalpendingtotal?token=';
  ...
  static const String withdrawalListUri = '/api/v1/delivery-man/driver-withdrawalhistory?token=';
