...
import 'package:sixam_mart_delivery/view/screens/withdraw/updateBankScreen.dart';
import 'package:sixam_mart_delivery/view/screens/withdraw/withdrawal_list.dart';

import '../view/screens/withdraw/withdraw.dart';
...
class RouteHelper {
  ...
  static const String bankUpdate = '/update-bank';
  ...
  static const String withdrawalListScreen = '/withdrawal-list-screen';
  ...
  static String getWithdrawalListRoute() => withdrawalListScreen;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: bankUpdate, page: () => const UpdateBankScreen()),
    ...
    GetPage(name: withdrawalListScreen, page: () => const WithdrawalScreen()),
