...
class _DeliveryManRegistrationScreenState extends State<DeliveryManRegistrationScreen> {
  ...
  final FocusNode _bankNode = FocusNode();
  final FocusNode _accNumNode = FocusNode();
  ...
  void initState() {
    ...
    Get.find<AuthController>().getCompanyList();
        ...
        return Column(children: [
          ...
          Expanded(child: SingleChildScrollView(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Container(
                  ...
                  child: DropdownButton<String>(
                    ...
                    onChanged: (value) {
                      ...
                      if(value == 'salary_based'){
                        setState(() {
                          cDriver = true;
                          companyDriver = authController.companyList?[0].id;
                        });
                      } else {
                        setState(() {
                          cDriver = false;
              ...
              cDriver != false ? const SizedBox(height: Dimensions.paddingSizeLarge) : SizedBox.shrink(),
              cDriver != false ? Row(children: [
                const SizedBox(width: Dimensions.paddingSizeSmall),
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                  authController.companyList != null ? Container(
                    padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                    decoration: BoxDecoration(
                      color: Theme.of(context).cardColor, borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                      // boxShadow: [BoxShadow(color: Colors.grey[Get.isDarkMode ? 800 : 200], spreadRadius: 2, blurRadius: 5, offset: Offset(0, 5))],
                    ...
                    child: DropdownButton<int>(
                      ...
                      items: zoneIndexList.map((int value) {
                        return DropdownMenuItem<int>(
                          value: value,
                          child: Text(authController.companyList![value].name!.toString()),
                        );
                      }).toList(),
                      onChanged: (value) {
                        setState(() {
                          company = value;
                          companyDriver = authController.companyList![value!].id;
                        });
                        print(companyDriver);
                      },
                      isExpanded: true,
  ...
  void _addDeliveryMan(AuthController authController) async {
    ...
    if(fName.isEmpty) {
      ...
      showCustomSnackBar('Please enter your bank'.tr);
    }else if(fullName.isEmpty) {
      showCustomSnackBar('Please enter your bank name'.tr);
    }else if(accNum.isEmpty) {
      showCustomSnackBar('Please enter your account number'.tr);
    }else if(accNum.length != 10) {
      showCustomSnackBar('Please enter a valid account number'.tr);
    }else if(!isValid) {
      ...
      print("company id is "+ companyDriver.toString());
      authController.registerDeliveryMan(DeliveryManBody(
        ...
        vehicleId: authController.vehicles![authController.vehicleIndex! - 1].id.toString(), bank: bank, accNum: accNum, accName: fullName, delcomId: companyDriver.toString()
      ));
    }
  }
}
