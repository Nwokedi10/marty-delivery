        ...
        return authController.profileModel == null ? const Center(child: CircularProgressIndicator()) : ProfileBgWidget(
          ...
          mainWidget: SingleChildScrollView(physics: const BouncingScrollPhysics(), child: Center(child: Container(
            ...
            child: Column(children: [
              ...
              ProfileButton(icon: Icons.wallet, title: 'Withdrawal History', onTap: () {
                Get.toNamed(RouteHelper.getWithdrawalListRoute());
              }),
              ...
              ProfileButton(icon: Icons.house, title: 'Edit Bank Details'.tr, onTap: () {
                Get.toNamed(RouteHelper.getBankDetailsUpdateRoute());
              }),
              const SizedBox(height: Dimensions.paddingSizeSmall),
              ...
              ProfileButton(icon: Icons.logout, title: 'logout'.tr, onTap: () {
                ...
                Get.dialog(ConfirmationDialog(icon: Images.support, description: 'are_you_sure_to_logout'.tr, isLogOut: true, onYesPressed: () async {
                  ...
                  await Get.offAllNamed(RouteHelper.getSignInRoute());
                }));
              }),
