...
class HomeScreen extends StatelessWidget {
  ...
  Future<void> _loadData() async {
    ...
    await Get.find<AuthController>().getWithdrawalStatus();
    await Get.find<OrderController>().getCurrentOrders();
    await Get.find<AuthController>().getWithdrawalList();
    await Get.find<AuthController>().getTotalWith();
    await Get.find<AuthController>().newBankInfo();
        ...
        child: SingleChildScrollView(
          ...
          child: GetBuilder<AuthController>(builder: (authController) {
            ...
            return Column(children: [
              ...
              const SizedBox(height: Dimensions.paddingSizeSmall),
              authController.withModel?.status.toString() == '1' ?
              GestureDetector(
                onTap: (){
                  Get.toNamed(RouteHelper.getWithdrawalHelper());
                },
                child: CountCard(
                  title: 'Withdraw', backgroundColor: Colors.green, height: 140,
                  value: authController.profileModel != null
                      ? PriceConverter.convertPrice(authController.profileModel!.balance) : null,
                ),
              ) : SizedBox.shrink(),
