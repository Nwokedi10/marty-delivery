...
class WithdrawBgWidget extends StatelessWidget {
  final Widget mainWidget;
  final bool backButton;
  const WithdrawBgWidget({Key? key, required this.mainWidget, required this.backButton}) : super(key: key);
    ...
    return Column(children: [
      ...
      Stack(clipBehavior: Clip.none, children: [
        ...
        Positioned(
          ...
          child: Text(
            'Update Bank'.tr, textAlign: TextAlign.center,
